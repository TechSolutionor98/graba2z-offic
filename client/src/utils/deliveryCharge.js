...
//
// MIRROR of `server/utils/deliveryCharge.js`, which is the canonical implementation.
// The two must stay in step: the storefront quotes the shipping and the order endpoint
// charges it, and if they ever disagree the card payment fails amount verification
// outright -- precisely the class of bug that shipped once already.
//
