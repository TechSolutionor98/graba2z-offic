    ...
    <div dir="rtl" className="bg-white min-h-screen px-4 md:px-12 py-10 font-sans text-gray-900">
      <div className="max-w-5xl mx-auto">
        ...
        <section className="space-y-6 text-base leading-8">
          ...
          <div>
            <h2 className="text-xl font-semibold text-black mb-2">الاحتفاظ بالبيانات وحذفها</h2>
            <ul className="list-disc pr-6 space-y-2">
              <li>نحتفظ ببياناتك الشخصية (مثل الاسم والبريد الإلكتروني ورقم الهاتف والعنوان) طالما كان حسابك نشطًا أو حسب الحاجة لتقديم خدماتنا لك.</li>
              <li>نحتفظ بسجل المعاملات وتفاصيل الطلب كما هو مطلوب بموجب القوانين التجارية والضريبية والتنظيمية المعمول بها في دولة الإمارات العربية المتحدة.</li>
              <li>يمكنك طلب حذف حسابك وبياناتك الشخصية في أي وقت من خلال إعدادات التطبيق أو عن طريق الاتصال بدعم العملاء لدينا على <span className="text-blue-600">customercare@grabatoz.ae</span>.</li>
              <li>عند تلقي طلب الحذف، سنقوم بحذف بياناتك الشخصية أو إخفاء هويتها في غضون 30 يومًا، باستثناء البيانات التي يتعين علينا الاحتفاظ بها قانونًا لأغراض تنظيمية أو امتثال أو منع الاحتيال.</li>
            </ul>
          </div>
