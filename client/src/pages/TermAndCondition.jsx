          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="md:order-1">
              <div className="flex flex-col md:flex-row md:items-center gap-3 mb-6">
                ...
                <h2 className="text-xl font-semibold text-gray-900 text-center md:text-left">4. Order Cancellation</h2>
              </div>
              
              <div className="space-y-4 text-gray-700">
                <p>
               <strong> By Grabatoz:</strong> We reserve the right to cancel orders due to stock issues, pricing errors, or fraud concerns.                </p>
                <p>
                <strong> By Customer:</strong> You may cancel an order before it is processed. Once shipped, cancellations are not permitted.                </p>
              </div>
       <br />
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="md:order-1">
              <div className="flex flex-col md:flex-row md:items-center gap-3 mb-6">
                ...
                <h2 className="text-xl font-semibold text-gray-900 text-center md:text-left">5. Third-Party & Branded Product Disclaimer</h2>
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="md:order-1">
              <div className="flex flex-col md:flex-row md:items-center gap-3 mb-6">
                ...
                <h2 className="text-xl font-semibold text-gray-900 text-center md:text-left">6. Payment & Credit Card Information</h2>
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="md:order-1">
              <div className="flex flex-col md:flex-row md:items-center gap-3 mb-6">
                ...
                <h2 className="text-xl font-semibold text-gray-900 text-center md:text-left">7. Declined or Fraudulent Transactions</h2>
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="md:order-1">
              <div className="flex flex-col md:flex-row md:items-center gap-3 mb-6">
                ...
                <h2 className="text-xl font-semibold text-gray-900 text-center md:text-left">8. Electronic Communications</h2>
              </div>
              
              <div className="space-y-4 text-gray-700">
              By visiting Grabatoz.ae or communicating with us electronically, you consent to receive communications from us electronically, including emails, notices, and updates.                 </div>
       <br />
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="md:order-1">
              <div className="flex flex-col md:flex-row md:items-center gap-3 mb-6">
                ...
                <h2 className="text-xl font-semibold text-gray-900 text-center md:text-left">9. Currency & Foreign Transactions</h2>
              </div>
...
<ul>
  ...
  <li>
  All transactions are processed in UAE Dirham (AED).
  </li>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="md:order-1">
              <div className="flex flex-col md:flex-row md:items-center gap-3 mb-6">
                ...
                <h2 className="text-xl font-semibold text-gray-900 text-center md:text-left">10. Product Availability & "On Demand" Items</h2>
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="md:order-1">
              <div className="flex flex-col md:flex-row md:items-center gap-3 mb-6">
                ...
                <h2 className="text-xl font-semibold text-gray-900 text-center md:text-left">11. Use of the Site</h2>
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="md:order-1">
              <div className="flex flex-col md:flex-row md:items-center gap-3 mb-6">
                ...
                <h2 className="text-xl font-semibold text-gray-900 text-center md:text-left">12. Colors & Product Display</h2>
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="md:order-1">
              <div className="flex flex-col md:flex-row md:items-center gap-3 mb-6">
                ...
                <h2 className="text-xl font-semibold text-gray-900 text-center md:text-left">13. Intellectual Property Rights</h2>
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="md:order-1">
              <div className="flex flex-col md:flex-row md:items-center gap-3 mb-6">
                ...
                <h2 className="text-xl font-semibold text-gray-900 text-center md:text-left">14. Reviews & Submissions</h2>
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="md:order-1">
              <div className="flex flex-col md:flex-row md:items-center gap-3 mb-6">
                ...
                <h2 className="text-xl font-semibold text-gray-900 text-center md:text-left">15. Indemnification</h2>
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="md:order-1">
              <div className="flex flex-col md:flex-row md:items-center gap-3 mb-6">
                ...
                <h2 className="text-xl font-semibold text-gray-900 text-center md:text-left">16. Indemnification</h2>
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="md:order-1">
              <div className="flex flex-col md:flex-row md:items-center gap-3 mb-6">
                ...
                <h2 className="text-xl font-semibold text-gray-900 text-center md:text-left">17. Governing Law & Jurisdiction</h2>
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="md:order-1">
              <div className="flex flex-col md:flex-row md:items-center gap-3 mb-6">
                ...
                <h2 className="text-xl font-semibold text-gray-900 text-center md:text-left">18. OFAC Compliance</h2>
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="md:order-1">
              <div className="flex flex-col md:flex-row md:items-center gap-3 mb-6">
                ...
                <h2 className="text-xl font-semibold text-gray-900 text-center md:text-left">19. Privacy Policy</h2>
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="md:order-1">
              <div className="flex flex-col md:flex-row md:items-center gap-3 mb-6">
                ...
                <h2 className="text-xl font-semibold text-gray-900 text-center md:text-left">20. Changes to Terms</h2>
              </div>
