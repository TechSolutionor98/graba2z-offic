        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
            ...
            <div className="text-center">
              ...
              <p className="text-lime-500"><TranslatedText>Daily 9:00 AM - 7:00 PM</TranslatedText></p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-lime-500"><TranslatedText>P.O. Box 241975, Dubai, UAE</TranslatedText></p>
            </div>
          </div>
