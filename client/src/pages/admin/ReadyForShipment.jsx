      ...
      <div className="ml-64 p-8">
                    ...
                    <tr key={order._id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm text-gray-900">
                          {order.shippingAddress?.name || order.pickupDetails?.location || "N/A"}
                        </div>
                        <div className="text-sm text-gray-500">
                          {order.shippingAddress?.email || order.pickupDetails?.phone || "N/A"}
                        </div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
        ...
        {filteredOrders.length === 0 && !loading && (
          <div className="text-center py-12">
            ...
            <div className="text-gray-500 text-lg mt-4">No orders ready for shipment</div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                  ...
                  <p className="text-gray-600">
                    <span className="font-medium">Name:</span> {selectedOrder.shippingAddress?.name || selectedOrder.pickupDetails?.location || "N/A"}
                  </p>
                  <p className="text-gray-600">
                    <span className="font-medium">Email:</span> {selectedOrder.shippingAddress?.email || selectedOrder.pickupDetails?.phone || "N/A"}
                  </p>
                  <p className="text-gray-600">
                    <span className="font-medium">Phone:</span> {selectedOrder.shippingAddress?.phone || selectedOrder.pickupDetails?.phone || "N/A"}
                  </p>
                </div>

                <div>
                  <h3 className="text-lg font-medium text-gray-900 mb-2">Shipping Actions</h3>
